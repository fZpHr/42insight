...
import { ExternalLink, BookOpen, Shield, Clock, Briefcase, Activity, GraduationCap, Map, PiggyBank, Swords, UsersRound } from 'lucide-react'
import Link from 'next/link'

const links = [
    {
        title: "Rusty",
        description: "Platform that simplifies student life, helping define educational paths and amplifying student voices for continuous improvement.",
    ...
    {
        title: "42 Subjects",
        description: "Intra is slow, so here is a faster way to access the subjects",
