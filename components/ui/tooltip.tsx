  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          // A panel rather than a coloured pill: these tooltips carry more than a
          // label -- the cluster map puts a login, a host and a list of people in
          // one -- and on a solid primary fill the muted text inside them went
          // unreadable as soon as primary became a strong blue.
